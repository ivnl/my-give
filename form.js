...
function validateForm() {
    ...
    else if (category == "education") window.open("cancer.html", '_self', 'resizable,location,menubar,toolbar,scrollbars,status');
    else if (category == "animals") window.open("cancer.html", '_self', 'resizable,location,menubar,toolbar,scrollbars,status');
    else if (category == "cultural") window.open("cancer.html", '_self', 'resizable,location,menubar,toolbar,scrollbars,status');
    else if (category == "community") window.open("cancer.html", '_self', 'resizable,location,menubar,toolbar,scrollbars,status');
    else if (category == "space") window.open("cancer.html", '_self', 'resizable,location,menubar,toolbar,scrollbars,status');
    else if (category == "science") window.open("cancer.html", '_self', 'resizable,location,menubar,toolbar,scrollbars,status');
    ...
    else if (category == "university") window.open("cancer.html", '_self', 'resizable,location,menubar,toolbar,scrollbars,status');
